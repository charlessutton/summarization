...
while patience < patience_limit :
    ...
    if valLoss < valLoss_min :
        valLoss_min = np.round(valLoss,5)
        patience = 0
        

        # summarize DUC
        fc_model_name = "fc_model_batch_"+str(batch_counter)+"k_valLoss_"+str(np.round(valLoss,5))
        ...
        if rouge_2_recall > rouge_2_recall_max or rouge_su4_recall > rouge_su4_recall_max :
            ...
            #save this new model
            fc_model_name = "fc_model_batch_"+str(batch_counter)+"k_valLoss_"+str(np.round(valLoss))+"_R2_"+str(rouge_2_recall)+"_SU4_"+str(rouge_su4_recall)
